...
public class SortBookDialog extends JDialog {
    final int WIDTH = 600;
    final int HEIGHT = 450;
    private ActionDoneListenerUtils listener;

    public SortBookDialog(JFrame frame, String title, boolean isModel, ActionDoneListenerUtils actionDoneListener) throws Exception {
        ...
        AddBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                BookManageUtils.SortPara[0] = selected; 
                BookManageUtils.SortPara[1] = eGroup.isSelected(asc.getModel()) ? 0 : 1;
